 ...
 */
package io.github.alexmofer.projectx.business.widgets.statelayout;
...
public class StateLayoutActivity extends AppCompatActivity implements
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        if (checkedId == R.id.sl_rb_normal) {
            mVState.normal();
        } else if (checkedId == R.id.sl_rb_loading) {
            mVState.loading();
        } else if (checkedId == R.id.sl_rb_error) {
            mVState.error();
        } else if (checkedId == R.id.sl_rb_empty) {
            mVState.empty();
        } else if (checkedId == R.id.sl_rb_drawable) {
        ...
        } else if (checkedId == R.id.sl_rb_view) {
