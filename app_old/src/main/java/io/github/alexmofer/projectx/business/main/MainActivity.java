 ...
 */
package io.github.alexmofer.projectx.business.main;
...
import io.github.alexmofer.projectx.business.about.AboutActivity;
import io.github.alexmofer.projectx.business.developing.DevelopingActivity;
import io.github.alexmofer.projectx.business.main.fragments.DevelopFragment;
import io.github.alexmofer.projectx.business.main.fragments.DrawablesFragment;
import io.github.alexmofer.projectx.business.main.fragments.OthersFragment;
import io.github.alexmofer.projectx.business.main.fragments.WidgetsFragment;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.main_nav_widgets) {
            setTitle(item.getTitle());
            setFragment(TAG_WIDGETS);
        } else if (id == R.id.main_nav_drawables) {
            setTitle(item.getTitle());
            setFragment(TAG_DRAWABLES);
        } else if (id == R.id.main_nav_others) {
            setTitle(item.getTitle());
            setFragment(TAG_OTHERS);
        } else if (id == R.id.main_nav_develop) {
            setTitle(item.getTitle());
            setFragment(TAG_DEVELOP);
        } else if (id == R.id.main_nav_report) {
            ContextUtils.openBrowser(this, REPORT);
        } else if (id == R.id.main_nav_contact) {
