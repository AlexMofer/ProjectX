...
public abstract class AbstractPollingIoConnector<T extends AbstractIoSession, H> extends AbstractIoConnector {
     ...
     * @param processorClass a {@link Class} of {@link IoProcessor} for the associated
     *                       {@link IoSession} type.
     ...
     *
     * @param sessionConfig the default configuration for the managed {@link IoSession}
     * @param processor     the {@link IoProcessor} for processing the {@link IoSession}
     ...
     *
     * @param sessionConfig the default configuration for the managed {@link IoSession}
     * @param executor      the {@link Executor} used for handling asynchronous execution
