...
public class ProfilerTimerFilter extends IoFilterAdapter {
     ...
     * {@link IoEventType}
     *
     * @param type The {@link IoEventType} that the user wants to get the total number of method calls
     ...
     *
     * @param type The {@link IoEventType} that the user wants to get the minimum time this method has
     *             executed
     ...
     *
     * @param type The {@link IoEventType} that the user wants to get the maximum time this method has
     *             executed
