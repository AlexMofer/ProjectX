...
public class BilateralPaneActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.old_activity_bilateralpane);
		...
		View pager1 = LayoutInflater.from(getBaseContext()).inflate(R.layout.old_item_bilateralpane_pager, pagerR, false);
		((TextView)pager1.findViewById(R.id.text)).setText("第一屏");
		pager1.setBackgroundColor(0xff00ddff);
		View pager2 = LayoutInflater.from(getBaseContext()).inflate(R.layout.old_item_bilateralpane_pager, pagerR, false);
		((TextView)pager2.findViewById(R.id.text)).setText("第二屏");
		pager2.setBackgroundColor(0xffffbb33);
		View pager3 = LayoutInflater.from(getBaseContext()).inflate(R.layout.old_item_bilateralpane_pager, pagerR, false);
		...
		View pager4 = LayoutInflater.from(getBaseContext()).inflate(R.layout.old_item_bilateralpane_pager, pagerL, false);
		((TextView)pager4.findViewById(R.id.text)).setText("第一屏");
		pager4.setBackgroundColor(0xff00ddff);
		View pager5 = LayoutInflater.from(getBaseContext()).inflate(R.layout.old_item_bilateralpane_pager, pagerL, false);
		((TextView)pager5.findViewById(R.id.text)).setText("第二屏");
		pager5.setBackgroundColor(0xffffbb33);
		View pager6 = LayoutInflater.from(getBaseContext()).inflate(R.layout.old_item_bilateralpane_pager, pagerL, false);
		...
		for (int i = 0; i < 95; i++) {
			...
			itemHashMap.put("item_image", R.drawable.old_ic_bilateralpane);
