...
public class TestActivityOld extends AMAppCompatActivity implements View.OnClickListener {

    private final DisplayAdapter mAdapter = new DisplayAdapter();
    private DisplayRecyclerView mVContent;

    public static void startActivity(Context context) {
        context.startActivity(new Intent(context, TestActivityOld.class));
    }
