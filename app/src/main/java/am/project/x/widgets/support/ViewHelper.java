package am.project.x.widgets.support;
...
public final class ViewHelper {
	...
	public static float getScrollX(View view) {
		return AnimatorProxy.NEEDS_PROXY ? AnimatorProxy.wrap(view).getScrollX() : Honeycomb
				.getScrollX(view);
	}
	...
	public static float getScrollY(View view) {
		return AnimatorProxy.NEEDS_PROXY ? AnimatorProxy.wrap(view).getScrollY() : Honeycomb
				.getScrollY(view);
	}
