...
public class CirclingDrawable extends Drawable implements Animatable {
	...
	public CirclingDrawable(int stroke, int color, Drawable center) {
		...
		mWidth = mDrawableCenter.getIntrinsicWidth() + mStrokeWidth * 2;
		mHeight = mDrawableCenter.getIntrinsicHeight() + mStrokeWidth * 2;
	...
	public void draw(Canvas canvas) {
		canvas.save();
		mDrawableCenter.setBounds(mStrokeWidth, mStrokeWidth, mWidth
				- mStrokeWidth, mHeight - mStrokeWidth);
		mDrawableCenter.draw(canvas);
		if (mIsRunning) {
			canvas.rotate(-90, mWidth * 0.5f, mHeight * 0.5f);
			mPaint.setColor(mColor);
			mRectF.set(mStrokeWidth * 0.5f, mStrokeWidth * 0.5f, mWidth
					- mStrokeWidth * 0.5f, mHeight - mStrokeWidth * 0.5f);
