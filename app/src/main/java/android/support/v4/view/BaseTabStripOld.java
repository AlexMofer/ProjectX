 ...
 * @author Alex
 */
public abstract class BaseTabStripOld extends View implements ViewPager.Decor {
    ...
    public BaseTabStripOld(Context context) {
        this(context, null);
    }

    public BaseTabStripOld(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public BaseTabStripOld(Context context, AttributeSet attrs, int defStyleAttr) {
