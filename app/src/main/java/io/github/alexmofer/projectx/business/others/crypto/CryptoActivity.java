...
public class CryptoActivity extends CommonActivity implements CryptoView, View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (TextUtils.isEmpty(input)) {
            InputMethodManagerUtils.showSoftInput(mVInput);
            return;
        }
        InputMethodManagerUtils.hideSoftInput(mVInput, false);
        if (mDLoading == null) {
        ...
        if (id == R.id.crypto_btn_message) {
            mPresenter.getMessage(input);
        } else if (id == R.id.crypto_btn_des) {
            mPresenter.getDES(input);
        } else if (id == R.id.crypto_btn_aes) {
            mPresenter.getAES(input);
        } else if (id == R.id.crypto_btn_rsa) {
