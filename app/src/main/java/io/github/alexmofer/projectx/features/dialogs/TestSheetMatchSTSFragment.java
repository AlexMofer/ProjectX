 ...
 */
public final class TestSheetMatchSTSFragment extends SheetDialogFragment {

    public TestSheetMatchSTSFragment() {
        super(true);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final View content = new ViewGroupBuilder(new ScrollView(context))
                ...
                .build();
        if (isSheet()) {
            AvoidArea.padding(content, AvoidArea.BOTTOM);
        }
        return new LinearLayoutBuilder(context)
                ...
                .addView(content,
                        new LayoutParamsBuilder()
                                .matchWidth()
                                .build())
                .setLayoutParams(new LayoutParamsBuilder().matchAll().build())
                .build();
    }
}
