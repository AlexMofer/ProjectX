...
public class CitysUtils {
	...
	public static class ProvinceDto {
		...
		public boolean isDirectControlled() {
			return province == null ? false : province.isDirectControlled();
		}
	}
	...
	public static class CityDto extends ProvinceDto {
		...
		public boolean isDirectControlled() {
			return city == null ? false : city.isDirectControlled();
		}
	...
	public static ArrayList<ProvinceDto> getProvinceList() {
		ArrayList<ProvinceDto> provinces = new ArrayList<CitysUtils.ProvinceDto>();
	...
	public static ArrayList<CityDto> getCityList() {
		ArrayList<CityDto> citys = new ArrayList<CitysUtils.CityDto>();
