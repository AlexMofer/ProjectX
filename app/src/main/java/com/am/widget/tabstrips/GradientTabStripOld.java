 ...
 *
 */
public class GradientTabStripOld extends BaseTabStripOld {
	...
	public GradientTabStripOld(Context context) {
		this(context, null);
	}

	public GradientTabStripOld(Context context, AttributeSet attrs) {
