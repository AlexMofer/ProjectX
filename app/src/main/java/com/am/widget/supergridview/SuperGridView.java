...
import com.am.widget.supergridview.DragView.OnViewDragListener;
import com.am.widget.supergridview.animator.GridMoveRunnable;
...
public class SuperGridView extends HeaderFooterGridView {
	...
	private void init(Context context) {
		...
		mDragView.setOnViewDragListener(new OnViewDragListener() {
