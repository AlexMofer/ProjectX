...
import com.am.widget.supergridview.animator.DragDeleteRunnable;
import com.am.widget.supergridview.animator.DragFlingRunnable;
import com.am.widget.supergridview.animator.DragFlingRunnable.CompareType;
import com.am.widget.supergridview.animator.DragMoveRunnable;
import com.am.widget.supergridview.animator.DragRemoveRunnable;
import com.am.widget.supergridview.animator.DragStartRunnable;
import com.am.widget.supergridview.support.Tools;
...
public class DragView extends ViewGroup {
	...
	public void setDrag(View child, boolean deleteable) {
		...
		case 0:
			...
			compareType = CompareType.YMIN;
			break;
		case 1:
			deleteInherentX = -(deleteWidth + deleteMove + deleteMargin);
			deleteInherentY = 0;
			compareType = CompareType.XMAX;
			break;
		case 2:
			deleteInherentX = 0;
			deleteInherentY = -(deleteHeight + deleteMove + deleteMargin);
			compareType = CompareType.YMAX;
			break;
		case 3:
			deleteInherentX = deleteWidth + deleteMove + deleteMargin;
			deleteInherentY = 0;
			compareType = CompareType.XMIN;
			break;
		}
