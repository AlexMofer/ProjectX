...
import com.am.widget.stateframelayout.StateFrameLayout.OnStateClickListener;
...
public class StateFrameActivity extends FragmentActivity {
	...
	public static class SimpleStateFrameFragment extends BasePagerFragment implements OnClickListener, OnStateClickListener{
	...
	public static class CustomStateFrameFragment extends BasePagerFragment implements OnClickListener, OnStateClickListener{
