...
class PagingScrollerCompat implements Runnable {
    ...
    PagingScrollerCompat(@NonNull Context context) {
        mScroller = ScrollerCompat.create(context, PublicRecyclerView.getScrollerInterpolator());
    }
