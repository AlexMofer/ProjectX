...
public class JobExecutor extends ThreadPoolExecutor {
    ...
    protected void beforeExecute(Thread t, Runnable r) {
        ...
        if (r instanceof Executable) {
            ((Executable) r).beforeExecute(this);
        }
    }
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        ...
        if (r instanceof Executable) {
            ((Executable) r).afterExecute(this);
        }
    }
    ...
    public interface Executable extends Runnable {
         ...
         * @param executor 执行者
         */
        void beforeExecute(@NonNull JobExecutor executor);
         ...
         * @param executor 执行者
         */
        void afterExecute(@NonNull JobExecutor executor);
    }
}